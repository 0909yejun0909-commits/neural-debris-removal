...
# --- step17c_emb_233.py (CPU - RELIABLE - 233 BASE) ---
STEP17C_CODE = r'''
import os
import json
import gc
...
log("V17C START (CPU MODE, 233 BASE)")
...
def find_paths():
    ...
    # MODIFIED: Use the 233.32 base CSV
    csv_candidates = list(Path("/kaggle/input").rglob("filter_length_uncond_stack_le40_or_47.0_49.0.csv"))
...
def main():
    Path("step17_embedding_dist.py").write_text(STEP17C_CODE)
    import subprocess
